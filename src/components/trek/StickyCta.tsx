/**
 * StickyCta — the persistent "Book / Enquire" call to action.
 *
 * Desktop: a sticky booking card (follows the page down the right rail).
 * Mobile: a fixed bottom action bar with Book Now + Enquire Now. Both use the
 * real booking route (`/book?trek=slug`) and contact route (`/contact`).
 *
        ...
        <>
            ...
            <aside className="cta-card">
                ...
                <dl className="cta-facts">
                    ...
                    <div>
                        <dt>Max altitude</dt>
                        <dd>{trek.altitude.split("/")[0].trim()}</dd>
                    </div>
                </dl>
